...
WD = r"/beegfs/jaenicke/klimertrag/"
os.chdir(WD)

LDK_MSK = "/beegfs/jaenicke/klimertrag/raster/administrative_masks/landkreise_1000.asc"
LDK_SHP = "/beegfs/jaenicke/klimertrag/vector/administrative/GER_landkreise_25832.shp"
CROP_MSK_PTH2 = "/beegfs/jaenicke/klimertrag/raster/crop_masks/CM_2017-2019_{0}_1000m_25832_q3.tiff"
# CROP_MSK_PTH2 = "/beegfs/jaenicke/klimertrag/raster/crop_masks/CTM_17-19_mask_1000m_25832.tiff"
# YIELD_PTH = "/beegfs/jaenicke/klimertrag/raster/sim-yields/field_condition_modifier_calibration/WRye"
# YIELD_PTH = "/beegfs/jaenicke/klimertrag/raster/sim-yields/preliminary_final_results"
# YIELD_PTH = "/beegfs/jaenicke/klimertrag/raster/sim-yields/testing_difference_to_anna/annas_zeitscheiben+fertilization_on"
YIELD_PTH = "/beegfs/jaenicke/klimertrag/raster/sim-yields/11_final_results"
# YIELD_PTH = "/beegfs/jaenicke/klimertrag/raster/sim-yields/testing_with_ehsan/new_setup"

RUN_IDS = [18]

## Preliminary final results
# RUN_IDS = [155,163,173,179,189,171,204]


OBS_PTH_LDK = rf"/beegfs/jaenicke/klimertrag/tables/reference_yields_landkreise/Ertraege_Landkreise_10_Frucharten_1999-2020_detrended.csv"
OBS_PTH_GER = rf"/beegfs/jaenicke/klimertrag/tables/reference_yields_landkreise/Ertraege_Deutschland_10_Frucharten_1999-2020_detrended.csv"

# OUT_FOLDER_TABLES = rf"/beegfs/jaenicke/klimertrag/tables/03_validation_field_condition_modifier/WRye"
# OUT_FOLDER_FIGURES = rf"/beegfs/jaenicke/klimertrag/figures/03_validation_field_condition_modifier/WRye"
# OUT_FOLDER_TABLES = "/beegfs/jaenicke/klimertrag/tables/08_testing_difference_to_anna"
# OUT_FOLDER_FIGURES = "/beegfs/jaenicke/klimertrag/figures/08_testing_difference_to_anna"
OUT_FOLDER_TABLES = "/beegfs/jaenicke/klimertrag/tables/11_final_results"
OUT_FOLDER_FIGURES = "/beegfs/jaenicke/klimertrag/figures/11_final_results"
# OUT_FOLDER_TABLES = "/beegfs/jaenicke/klimertrag/tables/07_testing_with_ehsan"
# OUT_FOLDER_FIGURES = "/beegfs/jaenicke/klimertrag/figures/07_testing_with_ehsan"
...
# CROPS = {
#     'WW': [list(range(2003, 2020)),86],
#     'SM': [list(range(1991, 2020)),32],
#     'WB': [list(range(1991, 2020)),86],
#     'WR': [list(range(2003, 2020)),91],
